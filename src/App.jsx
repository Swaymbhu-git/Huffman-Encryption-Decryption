...
function App() {
  ...
  const handleCompress = () => {
    ...
    // Update compressed size calculation
    const totalSize =
      treeLengthBuffer.byteLength + treeBuffer.length + binaryBuffer.length;
    setCompressedSize(totalSize); // Update the displayed size
  
    setCompressedContent(encodedText); // Keep this for UI display
  };
